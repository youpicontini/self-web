...
?>
	  ...
	  ?>
      <div class="<?php if ( !is_singular()):?>project-thumbnail col-xs-12 col-md-6<?php endif; ?>" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <!-- check if the post has a Post Thumbnail assigned to it. -->
        <?php if ( is_singular() && has_post_thumbnail() ) : ?>
        <?php /*the_post_thumbnail( 'full' );*/ ?>
        <?php elseif ( has_post_thumbnail() ) : ?>
        <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="page-fadeOut">
        <?php the_post_thumbnail( 'full' ); ?>
        ...
        <?php if ( is_singular() ) : ?>
          <div class="col-xs-12 col-sm-offset-3 col-md-offset-0">
              <p class="title-project"><?php the_title(); ?></p>
          </div>
          <div class="col-xs-12 col-sm-3 project-content-text">
          <p>
        ...
        <?php endif; ?>
        <?php if ( is_singular() ) : ?>
            <div class="col-xs-12 col-sm-offset-3 col-sm-9 project-content">
